...
namespace C_Connector
{
    public class ServiceCodeHttps
    {
        ...
        private static readonly string REGISTER_END_USER_URI = "https://secuotp.com/SecuOTP-Service/manage/register/end-user";
        ...
        private static readonly string DISABLE_END_USER_URI = "https://secuotp.com/SecuOTP-Service/manage/disable/end-user";
        ...
        private static readonly string GENERATE_ONE_TIME_PASSWORD_URI = "https://secuotp.com/SecuOTP-Service/otp/generate";
        ...
        private static readonly string AUTHENTICATE_ONE_TIME_PASSWORD_URI = "https://secuotp.com/SecuOTP-Service/otp/authenticate";
        ...
        private static readonly string MIGRATE_ONE_TIME_PASSWORD_CHANNEL_URI = "https://secuotp.com/SecuOTP-Service/otp/migrate";
        ...
        private static readonly string GET_END_USER_DATA_URI = "https://secuotp.com/SecuOTP-Service/user/end-user";
        ...
        private static readonly string PUT_END_USER_DATA_URI = "https://secuotp.com/SecuOTP-Service/user/end-user";
