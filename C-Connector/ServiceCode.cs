...
namespace C_Connector
{
    ...
    {   
        ...
        private static readonly string REGISTER_END_USER_URI = "http://secure.secuotp.co.th/SecuOTP-Service/manage/register/end-user";
        ...
        private static readonly string DISABLE_END_USER_URI = "http://secure.secuotp.co.th/SecuOTP-Service/manage/disable/end-user";
        ...
        private static readonly string GENERATE_ONE_TIME_PASSWORD_URI = "http://secure.secuotp.co.th/SecuOTP-Service/otp/generate";
        ...
        private static readonly string AUTHENTICATE_ONE_TIME_PASSWORD_URI = "http://secure.secuotp.co.th/SecuOTP-Service/otp/authenticate";
        ...
        private static readonly string MIGRATE_ONE_TIME_PASSWORD_CHANNEL_URI = "http://secure.secuotp.co.th/SecuOTP-Service/otp/migrate";

        private static readonly string TIME_SYNC = "O-02";
        private static readonly string TIME_SYNC_NAME = "Time Sync";
        private static readonly string TIME_SYNC_URI = "http://secure.secuotp.co.th/SecuOTP-Service/manage/end-user" + DateTime.Now.Millisecond;
        ...
        private static readonly string GET_END_USER_DATA_URI = "http://secure.secuotp.co.th/SecuOTP-Service/user/end-user";
        ...
        private static readonly string PUT_END_USER_DATA_URI = "http://secure.secuotp.co.th/SecuOTP-Service/user/end-user";
